...
public class FitnessApp {
        ...
        while (true) {
            ...
            switch (option) {
                ...
                case "3":   //Staff
                    ...
                    if (tempId != null) {
                        currentId = tempId;
                        staffFunction(); // Redirect to staff functionalities
                    } else {
    ...
    /**
     * This method is called when the staff successfully logs in
     *
     */
    public static void staffFunction(){
        Scanner scanner = new Scanner(System.in);
        while (true) {
            System.out.println("\nStaff Functionality Menu:");
            System.out.println("1) Manage Room Bookings");
            System.out.println("2) Monitor Fitness Equipment Maintenance");
            System.out.println("3) Update Class Schedules");
            System.out.println("4) Oversee Billing");
            ...
            switch (option) {
                case "1":
                    // Implement manage room bookings functionality
                    break;
                case "2":
                    monitorEquipmentMaintenance();
                    break;
                case "3":
                    // Implement update class schedules functionality
                    break;
                case "4":
                    // Implement oversee billing functionality
                    break;
                case "5":
                    // Implement process payments functionality
                    break;
                case "0":
                    return; // Exit staff functionalities and return to the main menu
                default:
                    System.out.println("Invalid option, please try again.");
            }
        }
    ...
    public static void monitorEquipmentMaintenance() {
        Scanner scanner = new Scanner(System.in);
        System.out.println("Enter the equipment ID to perform maintenance:");
        int equipmentId = scanner.nextInt();
        scanner.nextLine();

        System.out.println("Enter the maintenance date (yyyy-MM-dd):");
        String maintenanceDateStr = scanner.nextLine().trim();

        try {
            SimpleDateFormat dateFormat = new SimpleDateFormat("yyyy-MM-dd");
            java.util.Date parsedDate = dateFormat.parse(maintenanceDateStr);

            // Convert java.util.Date to java.sql.Date
            Date maintenanceDate = new Date(parsedDate.getTime());

            Equipment.performMaintenance(equipmentId, maintenanceDate);
